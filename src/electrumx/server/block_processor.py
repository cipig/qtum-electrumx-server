...
class BlockProcessor:
    ...
    async def check_and_advance_blocks_eventlogs(self, raw_blocks: Sequence[bytes], raw_eventlogs) -> None:
    ...
    def advance_blocks_eventlogs(self, blocks: Sequence['Block'], raw_eventlogs):
